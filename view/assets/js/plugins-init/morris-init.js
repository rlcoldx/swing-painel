	...
	var dzMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#707070', 'rgb(255, 193, 7)', '#1bd084'],
				//responsive:true,
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(255, 193, 7)', 'rgb(27, 208, 132)', '#707070'],
				resize: true
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#707070', 'rgb(16, 202, 147)', 'rgb(255, 193, 7)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
