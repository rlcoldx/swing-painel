 ...
 var dzSparkLine = function(){
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(255, 193, 7, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(255, 193, 7, 0.5)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(255, 193, 7, 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(255, 193, 7, 0.5)");
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(255, 193, 7, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(255, 193, 7, 0.5)");
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(255, 193, 7, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(255, 193, 7, 0.5)");
