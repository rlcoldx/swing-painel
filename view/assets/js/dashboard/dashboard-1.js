(function($) {
	...
	var aprovadas = parseInt($('#donutChart').attr('data-aprovadas'));
    var nao_concluidas = parseInt($('#donutChart').attr('data-nao-concluidas'));
    var recusadas = parseInt($('#donutChart').attr('data-recusadas'));

    var totalReservas = aprovadas + nao_concluidas + recusadas;

    var percAprovadas = (aprovadas / totalReservas) * 100;
    var percNaoConcluidas = (nao_concluidas / totalReservas) * 100;
    var percRecusadas = (recusadas / totalReservas) * 100;
...
var dzChartlist = function(){
	...
	var donutChart = function(){
		var options = {
          series: [percAprovadas, percNaoConcluidas, percRecusadas],
          chart: {
          type: 'donut',
        },
		  legend:{
