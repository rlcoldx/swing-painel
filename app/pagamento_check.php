<?php 
    ...
    if(@$_POST['token'] == TOKEN){
        ...
        $sql_check = $db->prepare("SELECT r.*, p.pagamento_status FROM reservas AS r LEFT JOIN pagamentos AS p ON p.id_reserva = r.id WHERE r.id_usuario = ? AND r.codigo_reserva = ?");
